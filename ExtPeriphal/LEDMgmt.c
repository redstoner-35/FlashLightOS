...
const char *LEDPattern[LEDPatternSize]=
 {
   ...
   "111122220000E",//红绿交错闪一次然后结束 1
	 ...
	 "2020D202020DD",//快速闪烁两次，暂停两秒，闪三次，ADC异常 13
	 ...
	 "2010201030103010DDD",//红绿色交替闪烁两次，橙绿交替闪烁两次然后暂停2秒重复 #内部挡位逻辑错误 21
	 "20102010301030103010DDD",//红绿色交替闪烁两次，橙绿交替闪烁3次然后暂停2秒重复 #电池过流保护 22
	 "333", //橙色常亮表示电池电量中等 23
	 "20202D10100101001010010DD", //红色灯快速闪三次，绿色灯闪7次，SPS自检异常 24
