...
//定义
#define Nb 4		/* 分组长度　Block size in words, 4 for AES256 */
#define Nk 8		/* 密钥长度　column number, as of 4xNk, 8 for AES256 */
#define Nr 14		/* 加密轮数　Number of rounds, 14 for AES256 */
...
int aes_ExpRoundKeys(uint32_t *keywords);  /* 密钥扩展 */
int aes_AddRoundKey(uint8_t round, uint8_t *state, const uint32_t *keywords);  /* 加植密钥 */
int aes_EncryptState(uint32_t *keywords, uint8_t *state);	/* 分组加密 */
int aes_DecryptState(uint32_t *keywords, uint8_t *state);	/* 分组解密 */
