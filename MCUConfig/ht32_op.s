...
;// <e0> Bootloader Waiting Time (0x1FF0002C)
;//  <i> Enable bootloader waiting time by write timeout value to 0x1FF0002C.
...
OPT_2C              EQU     OPT_BOOT_WAIT
    ELSE
      ...
      IF BOOT_OPT = 1 && WDT_OPT = 1
        The_selected_MCU_can_not_enable_Bootloader_Waiting_Time_(BOOT_OPT=1)_and_Watchdog_Timer_Auto_Enable_(WDT_OPT=1)_in_the_same_time.
      ENDIF
